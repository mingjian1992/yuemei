...
public class Page  implements Serializable{
	...
	private String getMixedTheme(){
		...
		if(currPage != 1){
			strBuff.append("<span class=\"xf_wylc_page_prev\"><a href=\""+upPage+"\">上一页</a></span>");
		}
		...
		if(currPage != totalPageCount){
			strBuff.append("&nbsp;<span class=\"xf_wylc_page_next\"><a href=\""+dwonPage+"\">下一页</a></span>");
		}
		strBuff.append("<span class=\"xf_wylc_page_text\">到第</span><span class=\"xf_wylc_page_input\">");
		strBuff.append("<input type=\"text\" id=\"currPageText\" value=\""+currPage+"\"></span>");
		strBuff.append("<span class=\"xf_wylc_page_text\">页</span><span class=\"xf_wylc_page_last\" id=\"jumpPage\">确定</span></div>");
		return strBuff.toString();
	}
